...
# Player
player_ss = SpriteSheet(pygame.image.load('assets/spritesheets/character-sprites2.png').convert_alpha(), 64, 64, BLACK, 2)
player_ss_attack = SpriteSheet(pygame.image.load('assets/spritesheets/character-sprites2.png').convert_alpha(), 64*3, 64*3, BLACK, 2)
...
# Hazards
fire_ss = SpriteSheet(pygame.image.load('assets/spritesheets/hazards/fire-loop.png').convert_alpha(), 24,32, BLACK, 4)
...
anim = {
    'player': {
        ...
        'death': Animation(player_ss, row=20, frames=6, speed=800)
    },
    'minotaur': {
